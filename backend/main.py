...
try:
    ...
    processor = WhisperProcessor.from_pretrained("Marwan-Kasem/Whisper-Medium-for-English-Accents")
    model = WhisperForConditionalGeneration.from_pretrained("Marwan-Kasem/Whisper-Medium-for-English-Accents")
